<template>
    <div v-if="questionTypeId" class="create-question-wrapper" :class="{'scroll-fixed':fixedScroll, 'laoding-center':$store.state.isLoading}">
        <div class="main-wrapper">
            <div class="create-question-container" v-if="$store.state.isLoading==false">
                <form @submit.prevent='showConfirmTrue' class="field-wrapper">
                    ...
                    <div v-if="formQuestionData.question_type==='並び替え'">orderに合わせて答えを設定してください。</div>
                    <div class="field">
                        <div class="input-box" ref='formName'>
                            <div class='each-title-container'>
                                <div class="each-title">
                    ...
                    <div class="texarea-field">
                     ...
                     <div class="texarea-field">
                        <div class="texarea-box">
                            ...
                            <textarea required class="text-box" v-on:focus="onFocus" v-model='formQuestionData.text' placeholder="here is not necessary. quiz label is main question text">
                            </textarea>
                        </div>       
                    </div>
        ...
        >
        <p class="notification-text">作成しました。</p>
        </div>
    </div>
</template>
...
export default {
    ...
    methods:{
                ...
                if(this.formDataReady){
                    response = await axios({
                        ...
                        data: {
                            ...
                            'text': this.formQuestionData.text,
        ...
        setQuestionDetailInfo() {
            ...
            this.questionDetailInfo.text = this.formQuestionData.text
