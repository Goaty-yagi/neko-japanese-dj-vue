...
from board.apis import (
    ...
    PatchBestAsnwer,
    UsertagForAUser,
    EachFavoriteQuestionCreate,
    FavoriteQuestionList
    # BestAsnweredQuestion
    # CenterOnlyTagList
    )
...
urlpatterns = [
  ...
  path('best-answer', PatchBestAsnwer.as_view()),
  # path('best-answer-questions', BestAsnweredQuestion.as_view()),
  ...
  path('favorite-question/<user>', FavoriteQuestionUpdate.as_view()),
  path('favorite-question-list', FavoriteQuestionList.as_view()),
  path('favorite-question-create/', FavoriteQuestionCreate.as_view()),
  path('each-favorite-question/', EachFavoriteQuestionCreate.as_view()),
...
#   path('center-only-tag/', CenterOnlyTagList.as_view()),  
  ...
  path('get-user-tag/', UsertagForAUser.as_view()),
]