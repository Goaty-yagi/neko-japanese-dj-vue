...
urlpatterns = [
  ...
  path('my-quiz-detail/<user>', MyQuizDetailApi.as_view()),
  ...
  path('quiz-taker-create/', QuizTakerCreateApi.as_view()),
  ...
  path('quiz-taker-detail/<user>', QuizTakerDetailApi.as_view()),
  ...
  path('quiz-taker-update/', QuizTakerUpdate.as_view()),
  # path('google-initialize/', GoogleInitializeApi.as_view()),
